...
namespace LINQSingleExample
{
    ...
    class Program
    {
        static void Main()
        {
            ...
            Console.WriteLine(resultEmployee1.EmpID + ", " + resultEmployee1.EmpName + ", " + resultEmployee1.Job + ", " + resultEmployee1.Salary);

            //SingleOrDefault
            Employee resultEmployee2 = employees.SingleOrDefault(emp => emp.Job == "Clerk");
            if (resultEmployee2 != null)
            {
                Console.WriteLine(resultEmployee2.EmpID + ", " + resultEmployee2.EmpName + ", " + resultEmployee2.Job + ", " + resultEmployee2.Salary);
            }
            else
            {
