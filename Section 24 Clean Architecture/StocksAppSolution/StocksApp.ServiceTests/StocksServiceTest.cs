...
namespace UnitTests
{
    public class StocksServiceTest
    {
        ...
        public async Task CreateBuyOrder_NullRequest_ToBeArgumentNullException()
        {
            ...
            {
                await _stocksCreateBuyOrderService.CreateBuyOrder(buyOrderRequest);
            };
        ...
        public async Task CreateBuyOrder_ProperBuyOrder_ToBeSuccessful()
        {
            ...
            //Act
            BuyOrderResponse actualBuyOrderResponse = await _stocksCreateBuyOrderService.CreateBuyOrder(buyOrderRequest);
        ...
        public async Task CreateSellOrder_NullRequest_ToBeArgumentNullException()
        {
            ...
            Func<Task> action = async () =>
            {
                await _stocksCreateSellOrderService.CreateSellOrder(sellOrderRequest);
            };
        ...
        public async Task CreateSellOrder_ProperBuyOrder_ToBeSuccessful()
        {
            ...
            //Act
            SellOrderResponse actualSellOrderResponse = await _stocksCreateSellOrderService.CreateSellOrder(sellOrderRequest);
        ...
        public async Task GetBuyOrders_EmptyList()
        {
            ...
            //Act
            List<BuyOrderResponse> actualBuyOrderResponses = await _stocksGetBuyOrdersService.GetBuyOrders();
        ...
        public async Task GetSellOrders_EmptyList()
        {
            ...
            //Act
            List<SellOrderResponse> actualSellOrderResponses = await _stocksGetSellOrdersService.GetSellOrders();
